...
//         switch( option ) {
//             case S2CapConstructors::from_center_height:
//             {
//                 CHECK_ARGS_LENGTH(env, argc, 3);
//                 S2Point center;
//                 double height;
//                 nifpp::get_throws(env, argv[1], center);
...
//             case S2CapConstructors::from_center_angle:
//             {
//                 CHECK_ARGS_LENGTH(env, argc, 3);
//                 S2Point center;
//                 S1Angle angle;
...
//                 nifpp::resource_ptr<S2Cap> s2cap_ptr = nifpp::construct_resource<S2Cap>(center, angle);
//                 return nifpp::make(env, s2cap_ptr);
//             }

//             case S2CapConstructors::from_center_area:
//             {
//                 CHECK_ARGS_LENGTH(env, argc, 3);
//                 S2Point center;
//                 double area;
